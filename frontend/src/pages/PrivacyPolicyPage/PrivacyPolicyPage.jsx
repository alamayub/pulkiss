...
/**
 * Privacy page for Pulkiss (informational; adjust for your jurisdiction with legal counsel if needed).
 */
    ...
    <div className={styles.wrap}>
      <article className={styles.article}>
        ...
        <p>
          ...
          updated&quot; note at the end of this page so visitors can see what changed.
        </p>
